            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-secondary-200 dark:border-secondary-700">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-3 mt-1.5">
                            <label className="flex items-center cursor-pointer">
                                <input type="radio" name="challansPerPage" value={3} checked={challansPerPage === 3} onChange={() => setChallansPerPage(3)} className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-secondary-300" />
                                <span className="ml-1.5 text-sm">3 per Page <span className="text-xs text-secondary-500">(Default)</span></span>
                            </label>
                            <label className="flex items-center cursor-pointer">
                                <input type="radio" name="challansPerPage" value={2} checked={challansPerPage === 2} onChange={() => setChallansPerPage(2)} className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-secondary-300" />
                                <span className="ml-1.5 text-sm">2 per Page</span>
                            </label>
                            <label className="flex items-center cursor-pointer">
                                <input type="radio" name="challansPerPage" value={1} checked={challansPerPage === 1} onChange={() => setChallansPerPage(1)} className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-secondary-300" />
